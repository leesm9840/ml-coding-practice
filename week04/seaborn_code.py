...
ax2.set_title('Swarm plot of Tip by Day and Gerder')
plt.savefig('./week04/Seaborn_Figure01.jpg')

# **빈도 그래프**
# figure에 2개의 서브 플롯을 생성
fig = plt.figure(figsiz=(15, 5))
ax1 = fig.add_subplot(1, 2, 1)
ax2 = fig.add_subplot(1, 2, 2)
...
sns.histplot(tip['tip'], bins=30, kde=True, color='skyblue')
...
plt.savefig('./week04/Sewaborn_Figure05.jpg')
