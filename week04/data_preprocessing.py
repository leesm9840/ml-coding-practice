...
def load_housing_data():
    ...
    if not tarball_path.is_file():
        ...
        with tarfile.open(tarball_path) as housing_tarball:
            housing_tarball.extractall(path="darasets")
...
housing["income_cat"] = pd.sut(housing["median_income"],
...
housing_labels = strat_train_set["median_house_valie"].copy()
...
outlire_pred = Isolation_forest.fit_predict(X)
...
ordinal_encoded = ordinal_encoder.fit_transform(housing_cat)
