...
plt.title('Survivedm Counts by Embarked Port on Titanic')
...
# 차이 강조를 위해 수평선 추가
plt.axvline(x=survived_count['male'], color='gray', linestyle='--', linewidth=1)
...
# 각 부모와 자녀의 수에 대ㅏㄴ 요금의 평균과 표준 편차 계산
